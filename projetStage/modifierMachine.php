...
if(isset($_GET['idMachine'])){
   ...
   require('config.php');
	$SQL = "SELECT * FROM `machine` WHERE idMachine='$idMachine' ";
...
.select{
  ...
  transition: all 0.3s ease;
    ...
    <body>
       ...
       <!-- Formulaire  -->
<div class="container">
    <div class="title">modifier une machine</div>
    <div class="content">
      <form method="post" enctype='multipart/form-data' >
        <div class="user-details">
          <div class="input-box">
            <span class="details">Designation</span>
            <input type="text" placeholder="Entrer le designation de la marque" name="des" value="<?=$lig['designation']?>" required>
          </div> 
          <div class="input-box">
            <span class="details">Date de creation</span>
            <input type="date" name="date" value="<?=$lig['dateCreation']?>" required>
          </div>
          <div class="input-box">
            <span class="details">vignette</span>
            <input type="file" name="vign" placeholder="la vignette de la marque"  value="<?=$lig['vignette']?>" required>
          </div>
          <div class="input-box">
            <span class="details">documentation</span>
            <input type="file" name="doc" placeholder="lien de documentation"  value="<?=$lig['lienDeTelechargement']?>" required>
          </div>
          <!-- debut -->
        <div class="input-box">
      ...
      <!-- filire fin -->
          ...
          <input type="radio" name="cat" value="1" <?php if($lig['categoryPG']=="1") { ?> checked <?php }?> id="dot-1">
          <input type="radio" name="cat" value="2" <?php if($lig['categoryPG']=="2") { ?> checked <?php }?> id="dot-2">
        ...
        <div class="format-details">
          <input type="radio" name="format" value="1" <?php if($lig['formatOffiGraph']=="1") { ?> checked <?php }?> id="dot-3">
          <input type="radio" name="format" value="2" <?php if($lig['formatOffiGraph']=="2") { ?> checked <?php }?> id="dot-4">
...
<?php
				if(isset($_POST['mod'])){
                    ...
                    //   1 petit 2 grand
                      ...
                      $vig=basename($_FILES['vign']['name']) ;
                      $vig=basename($_FILES['vign']['name']) ;
		$sql="UPDATE machine SET designation='$des',dateCreation='$date',vignette='$vig' ,lienDeTelechargement='$doc',idMarque='$marque' ,categoryPG='$catPG' ,
    formatOffiGraph='$format'  ,detai1='$det1' ,detai2='$det2' ,detai3='$det3'
