  ...
  background: 3c90ba;
   ...
   transition: 0.5s;
    ...
    <body>
     ...
     <!-- Formulaire  -->
<div class="container">
    <div class="title">Modifier la marque</div>
    <div class="content">
      <form method="post" enctype='multipart/form-data' >
        <div class="user-details">
          <div class="input-box">
            <span class="details">Designation</span>
            <input type="text" placeholder="Entrer le designation de la marque" name="des" value="<?=$lig['designationMar']?>" required>
          </div> 
          <div class="input-box">
            <span class="details">Date de creation</span>
            <input type="date" name="date" value="<?=$lig['dateDeCreation']?>" required>
          </div>
          <div class="input-box">
            <span class="details">vignette</span>
            <input type="file" name="vign" placeholder="la vignette de la marque" value="<?=$lig['logoImage']?>" required>
          </div>
          <!-- <div class="input-box"> -->
...
<?php
		...
		$sql="UPDATE marque SET designationMar='$des',dateDeCreation='$date',logoImage='$vig'
