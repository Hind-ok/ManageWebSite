 ...
 ?>
    ...
    <div class="container">
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-dark card-header">
        <a class="navbar-brand" href="../accueilPageAdmin"><i class="fas fa-home mr-2"></i>accueil </a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          ...
          <?php if (Session::get('id') == TRUE) { ?>
            ...
            <li class="nav-item">
              <a class="nav-link" href="../index"><i class="fas fa-sign-out-alt mr-2"></i>Logout</a>
            </li>
          <?php }else{ ?>
